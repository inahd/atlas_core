...
#compendium-preamble(
  title: "Carnatic Tala and Rhythm",
  subtitle: "Field Dive",
...
#title-page(
  title: "Carnatic Tala and Rhythm",
  subtitle: "Tala families, korvai rules, and the 35-tala system",
...
_Converted from `research/research_carnatic_tala_complete.md`. Content-lossless conversion._
...
Carnatic tāla in modern practice is most commonly taught and analyzed through the _Sulādi Sapta Tāla_ framework: seven canonical tāla families (Dhruva, Māṭya, Rūpaka, Jhampa, Tripuṭa, Aṭa, Eka), each defined by an ordered sequence of _aṅgas_—primarily _laghu_, _drutam_, and _anudrutam_—with the duration of laghu determined by one of five _jātis_ (tīśra = 3, caturasra = 4, khaṇḍa = 5, miśra = 7, saṅkīrṇa = 9). This produces the canonical _35 jāti-tāla variants_ (7×5), whose cycle-lengths (akṣara “counts”) can be computed deterministically from the aṅga pattern. Modern pedagogical charts (e.g., SIFAS and karnatik.com) explicitly tabulate these 35 tālas and their beat totals, and also preserve secondary “technical names” for each jāti-variant and alternative Sanskrit labels for the seven tāla families. citeturn38view8turn10search6

Primary classical sources such as _Bharata’s Nāṭyaśāstra_ and Śārṅgadeva’s _Saṅgītaratnākara_ are indispensable for anchoring the theory historically, but they do not present the Carnatic Sulādi Sapta Tāla system in its modern form; rather, they supply foundational concepts: tāla as a governing principle of musical time, classifications and terminology for tempo (laya), and older time/measure notions that later systems map into performer-facing tala-kriyā. In Nāṭyaśāstra (as translated by Ghosh) the “Time-Measure” (chapter XXXI in that volume’s numbering) explicitly frames _tāla as the regulator of measured performance_ and distinguishes _three layas_ (quick/druta, medium/madhya, slow/vilambita). citeturn38view5turn38view7

Konnakkol/solkaṭṭu (spoken rhythm) supplies the practical “symbolic phonology” that lets performers internalize and communicate counts, subdivisions, and cadences. Scholarly and practitioner-facing literature agrees on the _triple-structured cadence_ logic used in _mōra–korvai_ endings (especially in tani āvartanam), where carefully calculated phrase repetition and gap (kārvai) placement create a mathematically exact resolution to a chosen cycle-point (usually samam). citeturn9search0turn9search5turn9search15

For _planet/nakṣatra correspondences_, the most textually secure “classical” usage found in the core tāla literature is _not_ astrology but _tāla-technical terms_ such as _graha_ (in the Carnatic “daśa-prāṇa” sense: starting point/eduppu) and “graha” as discussed in older tāla theory. The primary sources reviewed here (Nāṭyaśāstra and the Saṅgītaratnākara-based scholarship reachable in this session) support that _graha_ is fundamentally a rhythmic/structural concept; explicit one-to-one mappings of Sulādi Sapta Tālas to planets or nakṣatras appear to be later, regionally variable overlays rather than clearly attested in the classical treatises requested. citeturn38view6turn9search19
...
In Carnatic pedagogy, “_akṣara_,” “_count_,” and sometimes “_mātrā_” are often used loosely to mean the basic pulse-unit of the tāla cycle as shown by hand-kriyā. Because the request explicitly asks for “mātrā totals,” this report uses a two-level convention:

- _Akṣara total_ = total counts per āvartana (cycle), computed from the aṅga sequence (laghu/drutam/anudrutam). This is what most modern charts label “No. of beats.” citeturn38view8turn10search6
- _Mātrā total in practice_ = akṣara total × _naḍai/gati_ (subdivision per akṣara: tīśra = 3, caturasra = 4, khaṇḍa = 5, miśra = 7, saṅkīrṇa = 9). Modern systems often discuss an expanded set of 7×5×5 = 175 “tālas” when combining _tāla family × jāti × gati_ (sometimes taught as 175 possibilities). citeturn9search25turn10search10

=== Primary texts used explicitly in this report


Bharata’s _Nāṭyaśāstra_, via Manomohan Ghosh’s translation (Vol. 2, chapters XXVIII–XXXVI). The “Time-Measure” section emphasizes tāla’s regulating role in performance and defines three layas (druta/madhya/vilambita), providing a historically early theoretical anchor for later laya/tāla pedagogy. citeturn38view5turn38view7

Śārṅgadeva’s _Saṅgītaratnākara_ (Talādhyāya) could not be reliably opened as a readable PDF in this session, so direct verse/page extraction from the edition was not feasible here. Where Saṅgītaratnākara statements are required (e.g., definitions of mātrā and standard time units), the report relies on peer-reviewed or scholarly secondary material that explicitly attributes these definitions to Saṅgītaratnākara. citeturn33search14turn10search13
...
A key conceptual bridge from classical Sanskrit metric/time theory into later tāla systems is the _mātrā_-based idea—laghu (light) vs guru (heavy) syllabic durations (1 vs 2 mātrās), and longer values such as pluta. A peer-reviewed mathematical-musicology study explicitly states that Saṅgītaratnākara (Śārṅgadeva) defines _a mātrā as the time required to pronounce five laghus_, and that Saṅgītaratnākara employs standard time-units _druta, laghu, guru, pluta_ (with guru and pluta being two and three laghus). citeturn33search14

This matters because modern Carnatic tāla pedagogy uses “laghu, drutam, anudrutam” as performer-facing aṅgas (hand gestures and counts) rather than as syllabic weight; yet the _names and proportional logic_ descend from older measure-concepts. The Nāṭyaśāstra likewise frames the necessity of tāla for measured performance and explicitly distinguishes tempo classes (layas), reinforcing that “timing” is a core concern of the classical system. citeturn38view5turn38view7
...
- _Laghu (laghu)_: a clap + finger counts; length is determined by jāti (3/4/5/7/9).
- _Drutam (drutam)_: a clap + wave; fixed length 2.
- _Anudrutam (anudrutam)_: a clap; fixed length 1.
...
Many Carnatic theory primers also discuss the larger aṅga set used in older/expanded tāla schemes (often linked with the _aṣṭottara-śata (108) tālas_): _guru_, _plutam_, _kākapāda_, etc., with larger fixed beat-values. A modern tala-system chart explicitly lists these (e.g., guru = 8, plutam = 12, kākapādam = 16 in one common counting convention), and also notes the standard South Indian symbols used alongside U/O/|. citeturn10search10turn10search3

Regional practice can vary in symbols: a Kerala talas study notes that laghu/druta/kākapāda symbols match the Carnatic vertical line/circle/plus conventions, but _anudruta and pluta may be notated differently_ (e.g., a reversed “L”-like form for anudruta, and a distinct composite sign for pluta). citeturn10search21
...
|---|---|---|---:|---:|---|---|
| laghu | laghu | `|` or `I` | jāti-dependent (3/4/5/7/9) citeturn38view8 | same laghu “base” | Use the gati syllables across the laghu’s internal counts: e.g., caturasra: _ta-ka-dhi-mi_ per beat-group citeturn9search9turn9search15 | “tuh-kuh-dhi-mi” (dhi as aspirated “dhee”) |
| drutam | drutam | `O` | 2 citeturn38view8 | 2 | _ta-ka_ (2) or (if subdividing) _ta ka_ citeturn9search9turn9search15 | “tuh-kuh” |
| anudrutam | anudrutam | `U` | 1 citeturn38view8 | 1 (or shown as part of composite in some lineages) citeturn10search3 | _ta_ (1) citeturn9search9turn9search15 | “tuh” |
...
- _tīśra-nadai (3)_: _ta-ki-ṭa_
- _caturasra-nadai (4)_: _ta-ka-dhi-mi_
- _khaṇḍa-nadai (5)_: _ta-ka-ṭa-ki-ta_
- _miśra-nadai (7)_: _ta-ki-ṭa ta-ka-dhi-mi_
- _saṅkīrṇa-nadai (9)_: a common 9-syllable fill is _ta-ka-dhi-mi ta-ka-ṭa-ki-ta_ (school-dependent)
...
The five jātis define the _laghu_ length, which in turn determines the akṣara total:
...
There is no single “theoretical default” jāti for every context, but modern usage strongly concentrates on a few instantiations: _Ādi tāla_ is the _caturasra-jāti Tripuṭa_ (8 akṣaras) in caturasra nadai; _Aṭa tāla_ is often used as _khaṇḍa-jāti Aṭa_ in advanced varnams; and pedagogical sources explicitly note the prevalence of these defaults in practice. citeturn12search6turn12search3
...
_Key_: L = laghu length (3/4/5/7/9). Drutam = 2. Anudrutam = 1.
...
| Rūpaka | caturasra | 4 | O I | 6 | _Rūpaka tāla_ in common practice often refers to this 6-count form | Patti citeturn38view8 |
...
| Jhampa | miśra | 7 | I U O | 10 | _Miśra Jhampa_ is a frequently taught/common instantiation | Sura citeturn38view8turn12search6 |
...
| Tripuṭa | caturasra | 4 | I O O | 8 | _Ādi tāla_ (most common concert tāla) citeturn38view8turn12search6 | Adi citeturn38view8 |
...
| Aṭa | khaṇḍa | 5 | I I O O | 14 | _Khaṇḍa Aṭa_ is widely used in varnams (common concert/dance practice) citeturn12search6 | Vidala citeturn38view8 |
...
Solkaṭṭu (also spelled solkattu / sollukattu) functions as a _rhythmic solfège_, used not only as drum mnemonics but as a language for teaching, analysis, and performance (konnakkol). citeturn9search9turn9search13

A practical way to define “canonical” sollukattu for tāla _as a meter_ (not as stroke-bols) is:
...
Below are “meter solkaṭṭu” examples using _caturasra-nadai_ (4 pulses per akṣara) unless stated otherwise. (These are counting syllables, not instrument-stroke syllables.)

| Tāla (common instantiation) | Aṅga structure | Akṣaras | Example meter solkaṭṭu (IAST) | Phonetic guide |
|---|---|---:|---|---|
| Ādi tāla (caturasra-jāti tripuṭa) | `I O O` = laghu–drutam–drutam | 8 citeturn38view8turn12search6 | (each akṣara: _ta-ka-dhi-mi_) → 8×4 = 32 syllables | “tuh-kuh-dhee-mee …” |
...
In Nāṭyaśāstra’s time-measure discussion, _tāla is explicitly described as the regulator of timing_ in dramatic/musical performance, and the text distinguishes _three layas_ (quick/druta, medium/madhya, slow/vilambita). citeturn38view5turn38view7

This classical framing matters because korvai construction is fundamentally the craft of creating phrase-structures whose _timing (counts) matches the tāla cycle and chosen laya/nadai_.
...
A practitioner primer similarly explains that _korvais are usually repeated three times and resolve on the first beat of the following cycle_ (samam), explicitly highlighting the triple structure and resolution requirement. citeturn9search15

Academic writing on the tani āvartanam observes the concluding placement of _mohra and korvai_, and computational research defines tani segments as culminating with mohra/korvai, each with its own nuances—supporting the idea that korvai has recognizable structural constraints. citeturn9search16turn9search27
...
_Definitions (Carnatic practice)_
A “korvai” here means a rhythmic composition articulated in solkaṭṭu that:

1. Has a specified _tāla_ (cycle), _jāti_ (laghu size), and typically a _nadai/gati_ (subdivision). citeturn38view8turn10search10
2. Has an _eduppu/graha_ (starting offset) which may be at samam (cycle start) or displaced; pedagogical descriptions treat eduppu as the place where a phrase begins relative to samam. citeturn9search19
3. Contains one or more segments (often described pedagogically as _pūrvāṅga_ and _uttarāṅga_, especially in mridangam tradition), concluding in a cadence that resolves exactly to the chosen landing point (typically samam). citeturn9search0turn9search18
4. Uses _triple repetition_ as a defining closure principle (P×3, or a more complex “mohra + korvai” where the final korvai is rendered three times). citeturn9search15turn9search27

_Rule A: Accountancy (kaṇakku) must close exactly_ (formalization)
Let:
...
_Rule B: Triple repetition with gaps (mōra logic)_
...
_Rule C: Landing point (arudi) and final “samam hit”_ (formalization)
In many traditions the korvai’s internal accents place an _arudi_ (a strong landing stress) either:
- on samam itself, or
...
All examples below are _worked in pulses_, with explicit closure checks. Solkaṭṭu syllables are presented in a neutral “counting” style (not stroke-bols).
...
Choose a mora design: _(P + k) + (P + k) + P_, with k = 4 pulses.

We need: 3|P| + 2|k| = 32 → 3|P| + 8 = 32 → |P| = 8.

Define P (8 pulses) as:
_ta-ka-dhi-mi ta-ka-jo-nu_ (8)
...
```mermaid
sequenceDiagram
  participant Cycle as 32 pulses (Adi, caturasra nadai)
  Cycle->>Cycle: P (8) + gap k (4)
  Cycle->>Cycle: P (8) + gap k (4)
  Cycle->>Cycle: P (8)
  Note over Cycle: Landing on samam (pulse 33)
```
...
_ta-ki-ṭa ta-ka_ (3 + 2 = 5) + _ta_ (1) → total 6
...
Define P (6 pulses): _ta-ka-dhi-mi ta-ka_.
...
_ta-ka-dhi-mi ta-ka-dhi-mi ta-ka-dhi-mi_.

Korvai length: 12 + 2 + 12 + 2 + 12 = 40 ✔.

Musically, this produces a strong “even-grouping” cadence against the uneven aṅga pattern of Jhampa (I U O), demonstrating that korvai arithmetic is independent of _where_ you place accents—provided the closure rule holds. citeturn9search15turn9search0
...
_ta-ki-ṭa | ta-ki-ṭa | ta-ki-ṭa | ta-ki-ṭa_
...
- g = 4 → T = 36 pulses.
- Eduppu: _1 pulse before samam_ (ateeta) → E = −1 (equivalently, start at pulse 35).
...
Define P (11) as: _ta-ka-dhi-mi ta-ka-dhi-mi ta-ka-ta_ (4+4+3=11; using a 3-syllable tail).
...
In the core tāla literature around Nāṭyaśāstra and Saṅgītaratnākara, “graha” most securely functions as a _tāla-structural term_ (i.e., a starting-point concept), which aligns closely with the Carnatic pedagogical definition of _eduppu/graha_ as the point where a musical phrase begins relative to the cycle’s samam. citeturn9search19turn38view6
...
The user request asks for “planet/nakṣatra correspondences” and “classical mappings.” In the sources reachable and usable in this session (including the Nāṭyaśāstra translation pages examined and the broadly used modern 35-tāla pedagogical charts), _explicit one-to-one mappings_ such as “Dhruva = Sun” or “Tripuṭa = Jupiter,” or mappings of the 35 tālas to nakṣatras, are _not attested_ in a way that can be responsibly presented as “classical” from Nāṭyaśāstra/Saṅgītaratnākara themselves.

What can be stated rigorously is:

- _Graha_ is a rhythm-structural term in tala theory and modern Carnatic pedagogy as eduppu. citeturn9search19turn38view6
...
Similarly, explicit “planet/nakṣatra correspondences” for Sulādi Sapta Tālas were _not found in the primary-text-accessible material_ used here; any such mappings would need verification from specific treatise passages that state them explicitly.
