...
#title-page(
  title: "Yoga and Pranayama",
  subtitle: "Asana, pranayama, and the breath-body interface",
...
_Converted from `research/research_pranayama_asana.md`. Content-lossless conversion._
...
This research request spans three epistemic layers that often get conflated: (a) _measured biophysical rhythms_ in plants and trees (chronobiology / ecophysiology), (b) _agricultural timing systems_ (biodynamic calendars; regional farming almanacs), and (c) _Jyotiṣa-based muhurta rules_ (nakṣatra/tithi/vāra classifications and auspiciousness). For an NPU Knowledge Graph, the most robust path is to store _all three as distinct claim types_ and connect them only through explicitly labeled inference edges (INTERPRETATION or SPECULATIVE), rather than treating traditional timing rules as “validated biology.”

A few high-load findings shape everything else:

Peer-reviewed tree ecophysiology shows _rhythmic tree-stem diameter variation_ that can correlate with the _lunisolar tidal acceleration_ (i.e., the diurnal/semidiurnal gravitational cycle), including in controlled conditions without daily light cues. citeturn27search0turn26view0turn27search14

This “tidal signature” is _not the same claim_ as “full moon makes sap rise” (a synodic phase claim). Lunar _phases are monthly_; lunisolar tides have strong _~12.4 h and ~24.8 h components_, and only modest spring-tide amplification near new/full moons. citeturn25view0turn26view0turn27search0

A critical review in agronomy/plant-science education argues there is _no reliable science-based evidence_ (in mainstream textbooks or peer-reviewed plant physiology) to justify _agricultural tasks conditioned by lunar phases_ (as commonly taught in popular tradition). citeturn25view0
_Important nuance for NPU:_ this conclusion is best read as “no reliable evidence for _phase-based prescriptions_ in common agronomic practice,” not “no lunar-linked biological rhythms exist at all,” because other peer-reviewed chronobiology papers do report lunar/tidal correlations in certain plant signals. citeturn26view0turn27search0turn28view0

Classical Jyotiṣa sources (via Varāhamihira’s _Bṛhat Saṁhitā_, in a modern English translation) explicitly codify _nakṣatra categories_ (e.g., Dhruva/Fixed; Tikṣṇa/Dreadful; Ugra/Fierce) and give “fit for” rules; for example, the Bṛhat Saṁhitā states that _Rohiṇī and the three Uttaras_ are “Dhruva/Fixed” and suitable for planting trees, sowing seeds, foundations, and other long-lasting undertakings. citeturn15view0turn8view1
This is a strong _TRADITIONAL attestation_, but it is not a biological mechanism claim.

Florida Zone 9b agriculture is dominated by _heat/humidity and frost windows_, making timing systems most useful when used as _fine-tuning within UF/IFAS-appropriate seasonal windows_, not as replacements for climate-based agronomy. citeturn24search6turn24search2
...
Peer-reviewed evidence exists for _tree water-status surrogates_ (especially stem-diameter fluctuations) showing correlation with lunisolar tidal acceleration. A well-cited Nature correspondence reported stem diameter fluctuations and a “strong correlation” with tides, interpreted as implicating lunar influence on internal water movement. citeturn27search0 A later peer-reviewed synthesis/analysis across multiple datasets argued that stem diameter time series track the turning points of the _lunisolar tidal profile_ and concluded the lunisolar tide can regulate stem diameter dilations under the described conditions. citeturn26view0turn27search14

What this does _not_ directly establish:

It does not straightforwardly validate the common agricultural claim “sap flow is higher at full moon and/or new moon.” The best-supported periodicities in these tree measurements are _daily (~24–25 h) and semidiurnal (~12 h) tidal components_, while “full vs new” is a _synodic (~29.5 d) phase framing_. citeturn25view0turn26view0turn27search0
...
Where “full/new moon” does appear in peer-reviewed discussion is often in relation to _bioelectrical stem potentials_ or amplitude modulation in some reported time series (e.g., cited in chronobiology discussions), but those claims are not yet a general agronomic lever. citeturn26view0turn28view0

_NPU modeling implication:_ store “tide-linked diurnal/semidiurnal rhythmicity in tree stem signals” as a PEER_REVIEWED biological phenomenon; store “full/new moon sap surge” as TRADITIONAL unless tied to a specific study and phenotype.

=== Germination rates by lunar phase


The chronobiology literature contains claims of lunar-linked signals in seeds (e.g., water uptake or metabolic oscillations) and reports that some species show maxima at certain moon times; a peer-reviewed review in _Earth, Moon, and Planets_ summarizes reports such as _bean seeds resorbing water_ with maxima at intervals related to new/full moon and quadratures, and also notes reports of better germination shortly before new moon in some experiments. citeturn28view0

However, a plant-science education review concludes that _there is no reliable science-based evidence_ in mainstream plant physiology textbooks or peer-reviewed plant biology supporting the widespread practice of scheduling agricultural tasks by lunar phases. citeturn25view0

Biodynamic-community reporting (ANECTODAL/OBSERVED rather than mainstream agronomy) describes multi-year trials and claims patterns such as winter rye germinating better when seeded before full moon, yet also reports that later growth can compensate and yields may not differ; it further reports that results generally did _not confirm_ the _Working with the Stars_ (Maria Thun) calendar recommendations in those comparisons. citeturn35view0

_Practical synthesis for your knowledge graph:_

“Which phase favors germination?” cannot be answered as a universal law. The best-supported stance is: _effects, if present, are species- and context-dependent_ and may be small compared with temperature, soil moisture, seed viability, and pathogen pressure. citeturn25view0turn35view0

Claims like “waxing favors leaf; waning favors root” are primarily _TRADITIONAL/ANECTODAL_ in the sources reviewed here, and should be encoded with low certainty unless you run local experiments. citeturn29view0turn25view0

=== Water uptake and “gravitational” mechanisms in plants


A common traditional mechanism narrative is “Moon gravity pulls water upward in plants.” The Agronomy review argues the Moon’s gravitational acceleration at Earth’s surface is tiny relative to Earth’s gravity and that a phase-based “sap rise” logic is physically inconsistent with the fact that tides have two highs and two lows each day; therefore, if gravity were driving plant water movement in a simple way, the strongest pattern should be _semidiurnal_, not monthly-phasic. citeturn25view0
...
_NPU modeling implication:_ distinguish (a) “phase-based” lunar folklore from (b) “continuous tidal acceleration” chronobiology; do not merge them into a single “Moon effect” node.
...
A field experiment on Norway spruce and sweet chestnut drying behavior reported _slight but significant variations with lunar periodicities_ (synodic and sidereal) alongside seasonal trends, raising questions about rhythmic wood–water relations. citeturn34view0

A forestry products analysis of 60 oaks felled across the four lunar phases during one lunar period reported _no significant differences_ in humidity, specific weight, or shrinkage (as summarized in an accessible abstract record). citeturn32search9

_NPU stance:_ encode “moon wood quality” as a contested domain: PEER_REVIEWED studies exist both suggesting small effects and suggesting null results; local species, felling season, and drying/storage conditions are likely dominant confounders. citeturn34view0turn32search9
...
Modern biodynamic calendars commonly map the Moon’s passage through zodiac constellations (earth/water/air/fire elements) to plant organ emphasis: _earth→root, water→leaf, air→flower, fire→fruit/seed_. A widely used biodynamic calendar publication describes this mapping and attributes its development to Maria Thun’s mid-20th-century observations, claiming “enhanced root growth” when sowing with Moon in earth constellations, etc. citeturn29view0
...
From an NPU perspective, treat “Kolisko/Thun findings” as _ANECTODAL/OBSERVED_ unless you can link to their original experimental records and independently evaluate design/replication and statistical handling. The sources accessed here contain secondary summaries and explicit notes that many subsequent investigations did not verify calendar claims straightforwardly. citeturn35view0turn25view0

=== Bridging biodynamic categories to Vedic nakshatra agriculture


Biodynamic categories depend on the Moon in _zodiac constellations/signs_ (element mapping), while Jyotiṣa agriculture often depends on _nakṣatra categories_ (Dhruva/Mṛdu/Cara/Kṣipra/Ugra/Tikṣṇa etc.) plus tithi and weekday. The Bṛhat Saṁhitā provides explicit nakṣatra classifications and use-cases (e.g., Dhruva suited for sowing and planting trees). citeturn15view0turn8view1

A workable NPU bridge (INTERPRETATION) is:

derive a nakṣatra’s _dominant zodiac element_ from its ecliptic segment (to compare with biodynamic element categories), while separately tracking its _muhurta quality class_ (Dhruva/Mṛdu/…); treat agreement as “coherence,” not validation.
...
The same translation also contains, in its tree-treatment section, a direct enumeration of nakṣatras recommended “by seers” for _planting trees_: the three Uttaras, Rohiṇī, Anurādhā, Citrā, Mṛgaśīrṣā, Revatī, Mūla, Viśākhā, Puṣya, Śravaṇa, Aśvinī, Hasta. citeturn8view1
...
The Bṛhat Saṁhitā provides the _presiding deities_ list for the nakṣatras in the same chapter as the functional groupings. citeturn15view0 That is sufficient for “nakshatra_deity” fields and for rule logic that references deity families (e.g., “Bṛhaspati family”).

The “element of each nakshatra” is not standardized in the same way across traditions; the most consistent bridge to biodynamic categories is _derived from the zodiac element_ (fire/earth/air/water) corresponding to the Moon’s location along the ecliptic. This mapping should be stored as _INTERPRETATION/DERIVED_, not “attested.” citeturn21search2turn29view0
...
A widely repeated Navagraha plant set in modern practice associates: Surya–Arka (_Calotropis_), Chandra–Palāśa (_Butea monosperma_), Mangala–Khadira (_Acacia catechu_), Budha–Apāmārga (_Achyranthes aspera_), Guru–Aśvattha (_Ficus religiosa_), Śukra–Udumbara (_Ficus racemosa_), Śani–Śamī (_Prosopis cineraria_), Rāhu–Dūrvā (_Cynodon dactylon_), Ketu–Darbha (_Imperata cylindrica_). citeturn22search4

In the sources reviewed here, this list is best treated as _TRADITIONAL (widely attested in modern “vatika” practice)_ unless a primary classical textual anchor is identified for each pairing.

=== Modern research parallels: what is reasonably supported


Surya → Arka (_Calotropis procera_ / _C. gigantea_). Modern phytochemistry reviews describe _Calotropis procera_ as rich in diverse compounds including _cardenolides_ (a class that includes _cardiac glycosides_) along with other phytochemicals. This provides a plausible modern parallel to “heart/circulation potency” narratives, but also flags toxicity risk. citeturn36search0

Guru (Jupiter) → Aśvattha (_Ficus religiosa_). An Elsevier ethnopharmacology review synthesizes traditional uses, phytochemistry, and pharmacology for _F. religiosa_, supporting that it has documented bioactivities (with the usual caveat: activity evidence ranges from in vitro to in vivo and is not identical to clinical proof). citeturn37search0

Śukra (Venus) → Udumbara (_Ficus racemosa_). Reviews discuss phytochemical constituents and pharmacological activities for _F. racemosa_, supporting at least a modern “bioactive plant” parallel (again, not necessarily clinical confirmation of the astrological body-system assignment). citeturn37search9

Ketu → Darbha (_Imperata cylindrica_). A peer-reviewed MDPI review in _Molecules_ surveys phytochemistry and pharmacology of _I. cylindrica_, supporting that it contains bioactives and is studied for diverse activities. citeturn38search0

Rāhu → Dūrvā (_Cynodon dactylon_). A systematic review summarizes pharmacognosy/phytochemistry/pharmacology of _C. dactylon_; quality of evidence varies by endpoint, but it supports the existence of multiple studied bioactivities. citeturn37search3
...
Permaculture zone design (Zone 0–5) is primarily about _frequency of access and intensity of management_ (Zone 1 close to the home; Zone 5 wild). citeturn24search1turn24search30turn24search24 Vedic timing can be integrated as a _scheduling overlay_:
...
Classical South Asian agriculture texts are typically not framed as “food forest permaculture” in modern terms, but they do include _tree-planting timing, orchard/garden management, and “treatment of trees”_ (vṛkṣāyurveda-like material) within broader civilizational planning. The Bṛhat Saṁhitā translation explicitly discusses tree treatment and gives nakṣatra timing for planting trees. citeturn8view1turn14view3
...
PHYT_Calotropis_Review_SAJB_2025 → review on _Calotropis procera_ phytochemistry/pharmacology. citeturn36search0
PHYT_FicusReligiosa_Review_JEthno_2011 → review on _Ficus religiosa_ phytochemistry/pharmacology. citeturn37search0
PHYT_FicusRacemosa_Review_TandF_2020 → review on _Ficus racemosa_ constituents and activities. citeturn37search9
PHYT_Imperata_Review_Molecules_2021 → MDPI Molecules review on _Imperata cylindrica_. citeturn38search0
PHYT_Cynodon_Review_2014 → systematic review on _Cynodon dactylon_. citeturn37search3
PHYT_Prosopis_Study_SciDirect_2023 → study on _Prosopis cineraria_ phyto-constituents and bioactivity models. citeturn37search10
...
`element_from_rasi` is _DERIVED_ (INTERPRETATION) from the standard sidereal zodiac element mapping used in biodynamic calendars (earth/water/air/fire). citeturn29view0turn21search2
...
This dataset uses the IndiaBiodiversity list as the baseline for the _27 nakshatra-associated plants_ and flags where that source itself lists regional alternates. citeturn11view0 The South African Journal of Botany review supports the broader notion of a 27-tree “nakshatravan” set with many documented medicinal properties and numerous reported compounds, but species-by-species details vary by tradition and region. citeturn23view0
...
The rules below combine: (a) nakṣatra element (derived), (b) Bṛhat Saṁhitā nakṣatra muhurta class (attested), (c) biodynamic plant-part category logic (traditional), and (d) Florida Zone 9b “season window” logic (agronomic). They should be tagged in your KG as _INTERPRETATION_ unless the rule is directly quoted from a text (which these are not).
...
1) _Textual rules_ (TRADITIONAL; with `source_text`, `verse/chapter`, and `translation_line_refs`)
2) _Empirical bio-rhythms_ (PEER_REVIEWED; with phenotype, species, periodicity, study design)
3) _Calendar overlays_ (biodynamic, panchang) as _tools_ (TRADITIONAL/ANECTODAL)
4) _Coherence inferences_ (INTERPRETATION/SPECULATIVE; with tunable weights)
