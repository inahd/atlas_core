...
#title-page(
  title: "Planetary Primes",
  subtitle: "Retrograde symmetries, the quantized field, and vertebral correspondence",
...
_Converted from `research/planetary-primes-v1.md`. Content-lossless conversion._
...
_RESEARCH-018_ | April 17, 2026 | Standalone paper draft
...
_Derivation._ The station count per cycle follows from the synodic period
...
_Tidal weights._ The tidal gravitational potential of a planet at Earth
scales as M over a cubed (mass over semi-major axis cubed). Normalized to Jupiter = 1:

| Planet | n | Mass (M(Earth)) | a (AU) | M over a cubed (relative) |
|--------|---|-----------|--------|-----------------|
...
| _Tidal-weighted (M over a cubed)_ | _{3,5,7,11}_ | _tidal_ | _44_ |
...
(Shankaranarayanan, _Sri Chakra_, 1971). Including the bindu (central point
...
_Geometry caveat._ The nodal lines of the quantized field are curved cosine
...
| Region | Count | Source |
|--------|-------|--------|
| Cervical | _7_ | Gray's Anatomy, 42nd ed., Ch. 42 |
| Thoracic | _12_ | Gray's Anatomy, 42nd ed., Ch. 42 |
| Lumbar | _5_ | Gray's Anatomy, 42nd ed., Ch. 42 |
...
- _C7 = Mars's retrograde symmetry number_
- _L5 = Venus's retrograde symmetry number_
- _T12 = 3 × 4 or 5 + 7_ (product/sum of the prime set)
- _C7 + T12 + L5 = 24_ = total presacral vertebrae

The Sri Yantra has _24 intersection points_ where the 9 triangles cross.
...
| Dog (_Canis familiaris_) | 7 | 13 | 7 | 27 | 27 | Evans & de Lahunta, _Miller's Anatomy of the Dog_, 4e |
| Cat (_Felis catus_) | 7 | 13 | 7 | 27 | 27 | Dyce, Sack & Wensing, _Textbook of Veterinary Anatomy_, 4e |
| Horse (_Equus caballus_) | 7 | 18 | 6 | 31 | 31 | Budras et al., _Anatomy of the Horse_, 6e |
| Cow (_Bos taurus_) | 7 | 13 | 6 | 26 | 26 | Budras et al., _Bovine Anatomy_ |
| Blue whale (_B. musculus_) | 7 | 15 | 14 | 36 | 36 | Crovetto, 1991; Buchholtz, 2001 |
| Common pipistrelle bat (_Pipistrellus pipistrellus_) | 7 | 11 | 5 | 23 | 23 | Vaughan et al., _Mammalogy_, 6e |
| Frog (_Rana_ spp.) | 0 | 0 | 0 | — | 9† | Duellman & Trueb, _Biology of Amphibians_ |
| Snake (Python) | 0 | ~300 | 0 | — | ~300 | Cundall, 1995 |
| Pigeon (_Columba livia_) | 14 | 7 | ~14 | ~35 | 35 | Baumel, _Handbook of Avian Anatomy_ |
...
_Bat vertebral note._ The formula C7 T11 L5 = 23 is reported for
_Pipistrellus pipistrellus_ (Vaughan et al.) and several other microchiropteran
...
_Mammalian C7 invariance._ The cervical count C=7 is conserved across
...
The adult human hand contains _27 bones_: 8 carpals + 5 metacarpals +
14 phalanges (Standring, _Gray's Anatomy_, 42e, Ch. 50). This is the
nakshatra number.

There are _44 marma points_ in the upper limb (shoulder through fingertips)
...
- Tidal amplitude weightings (M over a cubed) are physical constants.
...
Anatomical:
- Standring S (ed.). _Gray's Anatomy_, 42nd ed. Elsevier, 2021. Ch. 42 (spine), Ch. 50 (hand).
- Evans HE, de Lahunta A. _Miller's Anatomy of the Dog_, 4th ed. Saunders, 2013.
- Dyce KM, Sack WO, Wensing CJG. _Textbook of Veterinary Anatomy_, 4th ed. Saunders, 2010.
- Budras KD et al. _Anatomy of the Horse_, 6th ed. Schlütersche, 2012.
- Vaughan TA, Ryan JM, Czaplewski NJ. _Mammalogy_, 6th ed. Jones & Bartlett, 2015.
- Duellman WE, Trueb L. _Biology of Amphibians_. Johns Hopkins, 1994.
- Baumel JJ (ed.). _Handbook of Avian Anatomy: Nomina Anatomica Avium_, 2nd ed. Nuttall Ornithological Club, 1993.
- Burke AC, Nelson CE, Morgan BA, Tabin C. Hox genes and the evolution of vertebrate axial morphology. _Development_ 121:333–346, 1995.
- Narita Y, Kuratani S. Evolution of the vertebral formulae in mammals. _J Exp Zool B_ 304:91–106, 2005.

Astronomical:
- Swiss Ephemeris (Astrodienst AG), version 2.10.03. Lahiri ayanamsha.
- Meeus J. _Astronomical Algorithms_, 2nd ed. Willmann-Bell, 1998.

Traditional:
- Shankaranarayanan S. _Sri Chakra_. Dipti Publications, 1971.
