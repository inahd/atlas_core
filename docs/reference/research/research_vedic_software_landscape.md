...
| Cost | Listed price ~$254.95 (USD), with licensing details on vendor site. citeturn7view0 |
...
| Cost | SJS 9 Pro new order: **$318**. citeturn11view0 |
...
| Cost | **$299** per OS license; dual license **$450**. citeturn22search11turn27search13 |
...
| Cost | “Starts @ 26000” and “US$400” shown on the product page (currency formatting is ambiguous but indicates professional pricing tier). citeturn39view0 |
...
| What it does well | Strong settings surface for ayanāṁśa/node/house systems; breadth uncommon at $9.99. citeturn37view0 |
...
| Cost | Official support page lists **$30/month** or **$245/year** (platform pricing may differ if purchased via Apple/Google). citeturn48search0 |
...
| Cost | Subscription pricing is not clearly exposed on the main marketing page, but an App Store listing in the Down Dog ecosystem states memberships cost **$9.99/month or $59.99/year**. citeturn49search16turn49search0 |
...
- Kala is priced around $254.95. citeturn7view0  
- Parashara’s Light is $299 per platform. citeturn22search11turn27search13  
- Shri Jyoti Star 9 Pro is $318. citeturn11view0  
- Horosoft lists a “starts at” tier that includes an “US$400” reference. citeturn39view0  
