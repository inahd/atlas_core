"""
Multi-pair versor mode-decomposition dataset build for 2024.
PARQUET ONLY — no plots, no correlation matrix.

Mirrors the 2025 build at
research/geosolar/exploratory/mode_phase_multi_pair_2025/build_and_plot.py
operating on the 2024 grid. Used as one input to the cross-year
comparison at research/geosolar/exploratory/mode_phase_multi_year_comparison/.
...
Output:
  research/geosolar/exploratory/mode_phase_multi_pair_2024/
    all_pairs_modes_2024.parquet
"""
...
OUT = os.path.join(ROOT, "research/geosolar/exploratory/mode_phase_multi_pair_2024")
GRID = os.path.join(ROOT, "datasets/panchanga/grid_10min_2024.parquet")
OUT_PARQUET = os.path.join(OUT, "all_pairs_modes_2024.parquet")
...
def main():
    ...
    # NO PLOTS. NO CORRELATION MATRIX. Cross-year comparison happens in
    # research/geosolar/exploratory/mode_phase_multi_year_comparison.py.
    print()
    print("NOTE: This script intentionally does NOT compute or display the")
    print("      cross-pair correlation matrix or any related statistic.")
    print("      Cross-year comparison is in mode_phase_multi_year_comparison.py.")
    print()
